...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-64 border-r border-slate-200/80 bg-white/95 backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/95 md:block">
      <div className="flex h-full flex-col">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-zypta-blue/10 text-zypta-blue dark:bg-zypta-blue/20 shadow-sm"
        ...
        <div className="border-t border-slate-200/80 dark:border-slate-700 p-4">
          <Button
            variant="ghost"
